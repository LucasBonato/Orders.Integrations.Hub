...
using Orders.Integrations.Hub.Modules.Core.Orders.Application.Middlewares;
using Orders.Integrations.Hub.Modules.Core.Orders.Application.Providers;
...
namespace Orders.Integrations.Hub.Modules.Core;
...
public static class CoreDependencyInjection
{
    ...
    private static IServiceCollection AddClients(this IServiceCollection services)
    {
        services.AddHttpClient<IInternalClient, InternalClient>(client => {
            client.BaseAddress = new Uri(AppEnv..MONOLITH.ENDPOINT.BASE_URL.NotNull());
        });

        services.AddHttpClient<IOrderClient, OrderClient>(client => {
            client.BaseAddress = new Uri(AppEnv..ORDERS.ENDPOINT.BASE_URL.NotNull());
        });
