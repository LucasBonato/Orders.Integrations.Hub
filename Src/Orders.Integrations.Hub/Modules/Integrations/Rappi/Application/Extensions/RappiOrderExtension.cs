...
using Orders.Integrations.Hub.Modules.Core.Orders.Domain.Entity.Address;
...
using Orders.Integrations.Hub.Modules.Core.Orders.Domain.Entity.Payment;
...
using Orders.Integrations.Hub.Modules.Integrations.Rappi.Domain.ValueObjects.Enums;

using OrderPayment = Orders.Integrations.Hub.Modules.Core.Orders.Domain.Entity.Payment.OrderPayment;
using OrderTotal = Orders.Integrations.Hub.Modules.Core.Orders.Domain.Entity.OrderTotal;
