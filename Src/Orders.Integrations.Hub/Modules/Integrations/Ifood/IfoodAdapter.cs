...
using Orders.Integrations.Hub.Modules.Integrations.Saleschannels.Adapters.Ifood.Dtos;

using Microsoft.AspNetCore.Mvc;

namespace Orders.Integrations.Hub.Modules.Integrations.Saleschannels.Adapters.Ifood;
...
public static class IfoodAdapter
{
    public static async Task Webhook(
        ...
        [FromServices] IfoodToService ifoodTo
    ) {
        string? strBody;
