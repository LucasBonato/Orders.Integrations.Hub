...
public static class IFoodOrderExtension
{
    public static Order ToOrder(this IFoodOrder order, string tenantId)
    {
        ...
        return new Order(
            ...
            OrderTiming: order.FoodOrderTiming.ToOrder(),
    ...
    private static OrderTiming ToOrder(this IFoodOrderTiming foodOrderTiming)
    {
        return foodOrderTiming switch {
            IFoodOrderTiming.IMMEDIATE => OrderTiming.INSTANT,
            IFoodOrderTiming.SCHEDULED => OrderTiming.SCHEDULED,
